...
//3. В строке "String previousEntry = null;" у concurrentMap вызови метод, который
// вставит пару (randomInt, text) только для ключа, которого нет в concurrentMap.
...
//3. Метод run внутри метода getRunnable должен вызывать у concurrentMap метод, вставляющий
// пару (randomInt, text), если в concurrentMap еще нет пары со значением ключа randomInt.
