...
5. Метод refreshAllData в классе TaskDataProvider должен сохранять в список tasks результат
    работы метода getFakeTasks класса DbMock.
6. Метод refreshAllData в классе NameDataProvider должен сохранять в список names результат
    работы метода getFakeNames класса DbMock.
*/
public class Solution {
    // список объектов класса tasks
    private List<Task> tasks;
    // список имен
    private List<String> names;

    // поля-объекты интерфейса DbDataProvider
    ...
    private interface DbDataProvider<T> {
        // сигнатура интерфейса обязательная к реализации в классах реализующих интерфейс
