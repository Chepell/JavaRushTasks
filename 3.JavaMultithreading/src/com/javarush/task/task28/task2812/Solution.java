...
public class Solution {
    public static void main(String[] args) throws InterruptedException {
        ...
        // метод прерывает все текущие нити в пуле и возвращает список не выполненных нитей в потоке
        List<Runnable> runnables = executor.shutdownNow();
        // печать с помощью лямбда-выражения
        runnables.forEach((r) -> System.out.println(r + " was not completed"));
