...
public class Solution {
    ...
    public static void main(String[] args) throws Exception {
        // создаю потокобезопастную очередь максимальной длиной в 32 элемента
        BlockingQueue queue = new ArrayBlockingQueue(32);
        // создаю объект класса Producer принимающий в конструкторе параметром очередь
        Producer producer = new Producer(queue);
        // объект потребитель
        Consumer consumer = new Consumer(queue);

        // создание пула потоков, количество не задается, по требованию
