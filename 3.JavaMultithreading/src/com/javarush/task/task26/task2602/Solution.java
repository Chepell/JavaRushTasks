...
Отсортируй солдат, предварительно подумав, что лучше использовать
...
5. Метод compareTo(Soldier solder) должен сравнивать двоих солдат,
    учитывая только их рост. Сравнивать объекты нужно с учетом убывания роста солдат.
*/
public class Solution {
    ...
    public static class Soldier implements Comparable<Soldier> {
        ...
        public int compareTo(Soldier soldier) {
            return soldier.getHeight() - height;
        }
    }
}
