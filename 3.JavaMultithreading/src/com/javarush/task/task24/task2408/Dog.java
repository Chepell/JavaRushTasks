    ...
    public Sayable toSayable(final int i) {
        class DogPet extends SuperDog implements Sayable {
            private String getName() {
                String str = getSuperQuotes() + name + getSuperQuotes();
                return str;
            }
            ...
            public String say() {
                String message;
                if (i < 1) {
                    message = String.format("%s спит.", getName());
                } else {
                    ...
                    Date date = new Date();
                    message = String.format("%s лает г%sв! %s", getName(), sb.toString(), formatter.format(date));
                }
                return message;
            }
        }
