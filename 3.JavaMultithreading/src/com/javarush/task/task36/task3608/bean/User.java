...
// клас для хранения данных пользователей
public class User implements Cloneable {
    private String name;
    private final long id;
    private int level;
    // поле статичный нулевой объект класса
    ...
    // замена пустого конструктора, создается некий нулевой юзер
    public User() {
        this("", 0, 0);
    }
    ...
    //methods with logic
    // метод проверяет а не создавались ли уже объекты
    public boolean isNew() {
        return id == 0;
    }

    // методы клонирования объекта
    public User clone() {
        try {
