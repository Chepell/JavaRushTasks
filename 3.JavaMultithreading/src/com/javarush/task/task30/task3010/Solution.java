...
public class Solution {
    public static void main(String[] args) {
        try {
            ...
            for (int i = 2; i <= 36; i++) {
                try {
                    // пытаюсь конвертировать строку в число по основанию i
                    // если не получается то отлавливается исключение и идет следующий круг цикла с новым основанием
                    new BigInteger(args[0], i);
                    // если получилось то попадаю сюда, поднимаю флаг
                    flag = true;
//                    if (flag) {
