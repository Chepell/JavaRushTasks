...
public class Solution {
    public static void main(String[] args) {
        // вот такое обращение к элементам enum,
        // как вызов статочного поля и дальше вызов метода
        System.out.println(Alphabet.G.getLetterPosition()); // вернет 7 в консоль
    }
    ...
    public enum Alphabet {
        ...
        int getLetterPosition() {
            // ordinal() возвращает индекс как в массиве
            return ordinal() + 1;
        }
    }
}
