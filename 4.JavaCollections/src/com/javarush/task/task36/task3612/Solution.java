 ...
 * Каково же было их изумление, когда в этом множестве не
 * находится нужная дата - метод isLastDateContainsInDates возвращает false.
...
public class Solution {
	...
	// проверяет есть ли объект класса дата, поле текущего класс в множестве
