...
public class Solution {
    ...
    // статичный метод, доступный только внутри класса
    private static void printResults(boolean cat, boolean tiger, boolean pet) {
        if (cat && tiger && pet) System.out.println("Bingo!");
    }

    // статические классы т.к. они внутри класса Solution
    // если классы перенести за пределе Solution то можно без static
    static class Pet {
    }
