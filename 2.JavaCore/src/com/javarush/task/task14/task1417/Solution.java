...
4. В классах Hrivna, Ruble и USD реализуй метод getCurrencyName который
    будет возвращать название соответствующей валюты(строку) в виде аббревиатуры(USD, UAH, RUB).
...
public class Solution {
    ...
    static class Person {
        ...
        // поле списка валют класса
        private List<Money> allMoney;

        // конструктор класса с одним параметром
        Person(String name) {
            this.name = name;
            // остальные объекты класса инициируются тут же
            // создается список валют
            this.allMoney = new ArrayList<>();
            // добавляются объекты класса в список
            this.allMoney.add(new USD(600));
