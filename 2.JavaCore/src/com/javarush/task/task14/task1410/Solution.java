...
/* 
Дегустация вин
1. Создать абстрактный класс Drink с реализованным методом
    public void taste(), который выводит в консоль "Вкусно".
...
3. Создать класс BubblyWine, который наследуется от Wine, с реализованным
    методом public String getHolidayName(), который возвращает строку "Новый Год".
...
6. В классе BubblyWine должен быть реализован метод
...
public class Solution {
    ...
    // статические методы, что бы были доступны без создание объекта и прямо в самом классе
