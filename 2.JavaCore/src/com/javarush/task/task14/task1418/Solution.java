...
4. Найди блок кода который в цикле for выводит на экран содержимое
    списка и перемести его в метод printListValues.
5. Найди блок кода в котором для каждого объекта списка проверяется тип и
...
public class Solution {
    public static void main(String[] args) {
        // объявлется связанный список объектов Numbers
