...
public class Solution {
    public interface Alive {
        // блинн, String это ведь тоже Object
    ...
    public static class Finger extends BodyPart {
        // поле сохраняет информацию искуственный ли палец
        ...
        // переопределение реализации с добавлением проверки что не искуственный палец
        // искуственный точно не содержит костей
        public Object containsBones() {
