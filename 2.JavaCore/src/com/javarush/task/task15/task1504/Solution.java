...
4. Конструктор класса MarkTwainBook должен вызывать конструктор
    класса предка (Book) с параметром "Mark Twain".
5. Метод getBook в классе MarkTwainBook должен иметь тип возвращаемого
    значения MarkTwainBook и возвращать текущий объект.
...
9. Конструктор класса AgathaChristieBook должен вызывать конструктор класса
    предка (Book) с параметром "Agatha Christie".
10. Метод getBook в классе AgathaChristieBook должен иметь тип возвращаемого
    значения AgathaChristieBook и возвращать текущий объект.
...
public class Solution {
    public static void main(String[] args) {
        // обяъвление ссылочной переменной и указание на связанный список
    ...
    abstract static class Book {
        ...
        // прормежуточный, приватный метод, который проверяте принадлежность объекта конкретному классу-наследнику
        ...
        // переопределение публичного метода супер-класса Object
        // и он теперь возвращает приватный метод
    ...
    public static class MarkTwainBook extends Book {
        ...
        // но тут принимается аргументом title
        // а поле родительского класса author заполняется автоматически
        // через конструкцию super
