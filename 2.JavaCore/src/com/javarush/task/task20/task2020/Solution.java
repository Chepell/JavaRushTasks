...
3. Поле greetingString должно быть отмечено модификатором transient.
...
public class Solution {
    ...
    public static class Person implements Serializable {
        String firstName;
        String lastName;
        // поле просто компиляция предыдущих двух
        transient String fullName;
        // тут вообще просто строка, константа
...
//
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        Person human = new Person("Artem", "Voytenko", "Russia", Sex.MALE);
        System.out.println(human.fullName);

        OutputStream outputStream = new FileOutputStream("testFILE.txt");
        ...
        Person copyHuman = (Person) objectInputStream.readObject();

        objectInputStream.close();

        System.out.println(copyHuman.fullName);
