...
public class Solution {
    public static class Person implements Externalizable {
        ...
        // для реализации Externalizable нужен публичный конструктор без параметров
        public Person() {
        ...
        // в обоих метода важна последовательность полей
        // ведь байты читаются потоком и в итоге десериализуется не то поле если перепутать порядок
        @Override
