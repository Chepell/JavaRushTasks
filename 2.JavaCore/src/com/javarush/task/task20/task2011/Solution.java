...
5. В методе writeExternal, на полученном в качестве параметра объекте
    типа ObjectOutput должен быть вызван метод writeInt с параметром year.
...
public class Solution {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        Apartment home = new Apartment("г.Брянск, м-н Московский, 41/1 - 96", 2018);
        ...
        Apartment homeCopy = (Apartment) inputStream.readObject();
        inputStream.close();

        System.out.println(home);
        System.out.println(homeCopy);
