...
public class Solution {
    ...
    // класс принимая объект интерфейса ATable должен адаптировать его к BTable
    // в сигнатуре интерфейсом идет то к чему нужно адаптровать
    public static class TableAdapter implements BTable {
        // полем идет то что нужно адаптировать
        ...
        // метод интерфейса адаптирую использая поле класса
        @Override
