...
/* 
Ридер обертка
В методе main подмени объект System.out написанной
тобой ридер-оберткой по аналогии с лекцией.
...
4. Метод printSomething() класса TestString должен выводить
    на экран строку "it's a text for testing".
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        // создаю объект расширяемого байтового массива
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
        // создаю свой поток вывода на основе массива
        PrintStream stream = new PrintStream(outputStream);
        // меняю поток вывода на свой
        System.setOut(stream);
        // вызываю метод на объекте
        testString.printSomething();
        // возвращаю поток вывода на страндартный
        System.setOut(consoleStream);
        // массив конвертирую в строку и делаю буквы большими
