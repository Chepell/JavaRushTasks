...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        // создаю массив для хранения вывода
        ByteArrayOutputStream arrayOutputStream = new ByteArrayOutputStream();
        // создаю свой поток вывода
        PrintStream myStream = new PrintStream(arrayOutputStream);
        // меняю поток на свой
        System.setOut(myStream);
        // вызываю метод на объекте
        testString.printSomething();
        // создаю переменную строку для данных из массива
        String string = arrayOutputStream.toString().replace("te", "??");
        //меняю поток назад
        System.setOut(standartOut);
        // вывожу в консоль модифицированную строку
