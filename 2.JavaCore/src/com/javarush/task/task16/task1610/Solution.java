...
2. Расставь вызовы методов join() так,
    чтобы для каждой кошки выполнялось следующее:
...
public class Solution {
    ...
    private static void investigateWorld() {
        try {
//            System.out.println("Cat start sleeping");
            Thread.sleep(200);
//            System.out.println("Cat waked up");
    ...
    public static class Cat extends Thread {
        ...
        private void initAllKitten() throws InterruptedException {
            kitten1.start();
            kitten2.start();
            // торможу все потоки пока котята не отработают
            kitten1.join();
            kitten2.join();
        }
    }
