...
public class Solution {
    public static void main(String[] args) {
        // Создаю объект класса реализуюй интрефейс Runnable
        // и содержащий реазицию метода run
        TestThread task = new TestThread();
        // Создаю новый объект класса Thread, аргументом передаю ему объект моего класса
        // и далее сразу вызываю метод start
